...
| `RALPH_IMPL_MODEL` | No | Override the model for `impl-agent` — a raw model id (`haiku`, `sonnet`, `opus`, `fable`); default `sonnet`; BLOCKED escalation re-dispatches once at `opus` |
