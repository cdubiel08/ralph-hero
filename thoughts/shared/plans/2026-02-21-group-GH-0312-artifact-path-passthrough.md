...
### Success Criteria
- [ ] Automated: `grep -c "Artifact Passthrough Protocol" plugin/ralph-hero/skills/shared/conventions.md` returns 1
- [ ] Automated: `grep -c "\-\-research-doc" plugin/ralph-hero/skills/shared/conventions.md` returns >= 1
- [ ] Manual: Protocol section defines both flags, parsing rules, and lead extraction rules
