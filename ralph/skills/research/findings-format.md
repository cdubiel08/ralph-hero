...
|---|---|---|
| 0.80 – 1.00 | High | Multiple corroborating primary sources with direct quotes/code refs; no contradicting evidence found |
| 0.50 – 0.79 | Medium | Some supporting evidence but gaps; key support from secondary sources; one weak contradicting signal |
| 0.20 – 0.49 | Low | Sparse evidence; support mostly from weak sources; no direct confirmation |
| 0.00 – 0.19 | Insufficient | No meaningful evidence found after broad search |
