...
This is the background half of the capture custody chain: `/ralph:form --mode draft` writes `status: draft` + `captured`; this mode grounds each draft in codebase/prior-art/issue context before `/ralph:catch-up --mode brief` surfaces it.
