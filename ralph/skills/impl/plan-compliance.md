...
```bash
# Plan's File Ownership table lists: ralph/skills/impl/SKILL.md, ralph/hooks/scripts/impl-plan-required.sh
git add ralph/skills/impl/SKILL.md ralph/hooks/scripts/impl-plan-required.sh
