...
- **Multi-thought dump**: skip clarifying questions entirely — extract first, confirm after. Extract N distinct thoughts from the input, then present ONE confirmation listing the N titles:
